...
import (
	...
	"encoding/binary"
	"errors"
        "github.com/lucas-clemente/quic-go/internal/crypto/chacha20poly1305"	
        //"github.com/aead/chacha20"
        //"github.com/lucas-clemente/chacha20poly1305"
        //"github.com/liusenzhen/chacha20poly1305"
        //"github.com/liusenzhen/chacha20poly1305_super"
        //"git.schwanenlied.me/yawning/chacha20poly1305"
...
var _ AEAD = &aeadChacha20Poly1305{}
...
*/
	encrypter, err := aead.New(MyKey)
	if err != nil {
		return nil, err
	}
	decrypter, err := aead.New(OtherKey)
	if err != nil {
		return nil, err
	}
...
func (aead *aeadChacha20Poly1305) Overhead() int {
        return aead.encrypter.Overhead()
}
/*
func (n *aeadChacha20Poly1305) Overhead() int {
        return 8
}
*/
